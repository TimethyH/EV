// #include "game_framework_includes.h"
//
...
// static WindowMapByName g_WindowMapByName;
//
// static std::mutex g_WindowHandlesMutex;
//
...
//     , m_isRunning(false)
//     , m_requestQuit(false)
//     , m_terminateDirectoryChangeThread(false)
// {
...
//     m_terminateDirectoryChangeThread = true;
...
// {
//     while (!m_terminateDirectoryChangeThread)
//     {
//         scoped_lock lock(m_DirectoryChangeMutex);
//
