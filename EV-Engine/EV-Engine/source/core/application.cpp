...
#include "DX12/descriptor_allocation.h"
...
using namespace EV;
using WindowPtr = std::shared_ptr<EV::Window>;
...
std::shared_ptr<Window> Application::CreateRenderWindow(const std::wstring& windowName, uint32_t clientWidth, uint32_t clientHeight, bool vSync)
{
    ...
    RECT windowRect = { 0, 0, static_cast<int>(clientWidth), static_cast<int>(clientHeight) };
...
Microsoft::WRL::ComPtr<ID3D12Device13> Application::GetDevice() const
{
    return m_device;
}
...
MouseButtonEventArgs::MouseButton DecodeMouseButton(UINT messageID)
{
    ...
    {
        mouseButton = MouseButtonEventArgs::MouseButton::MIDDLE;
    }
    break;
    }
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    if (pWindow)
    {
        ...
        case WM_KEYDOWN:
        {
            ...
            pWindow->OnKeyPress(keyEventArgs);
        }
        break;
        case WM_SYSKEYUP:
        case WM_KEYUP:
        {
            ...
            pWindow->OnKeyRelease(keyEventArgs);
        }
        break;
        ...
        case WM_MBUTTONDOWN:
        {
            ...
            pWindow->OnMouseButtonPress(mouseButtonEventArgs);
        }
        break;
        case WM_LBUTTONUP:
        case WM_RBUTTONUP:
        case WM_MBUTTONUP:
        {
            ...
            pWindow->OnMouseButtonRelease(mouseButtonEventArgs);
        }
        break;
        case WM_MOUSEWHEEL:
        {
