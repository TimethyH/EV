...
// Static definitions.
std::mutex ResourceStateTracker::m_globalMutex;
bool ResourceStateTracker::m_isLocked = false;
ResourceStateTracker::ResourceStateMap ResourceStateTracker::m_globalResourceState;
